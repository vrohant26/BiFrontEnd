      ...
      <section className="contact-sec" id="contact">
        <div className="container expand-container">
          <div className="row align-items-center col-lg-12">
            <div className="col-12 col-lg-12 wow fadeIn" data-wow-delay=".2s">
              <form
            ...
            <div className="row padding-top padding-bottom col-12">
              <div className="col-4 col-lg-4 wow fadeIn" data-wow-delay=".2s">
                <h2 style={{ fontSize: "50px" }}>
                  We are in your neighborhood,{" "}
                </h2>
                <h2 style={{ fontSize: "40px", paddingBottom: "20px" }}>
                  Contact us today!
                </h2>
                <p
                  href="tel:13053742500"
                  style={{ fontSize: "20px", paddingBottom: "10px" }}
                >
                  Phone: +1 305-374-2500
                </p>
                <p style={{ fontSize: "20px", paddingBottom: "80px" }}>
                  Email: Info@brandinstitute.com
                </p>
                <p>Follow us on social media:</p>
                <ul
                  className="top-social-links fixed-nav-links inline"
                  style={{ fontSize: "40px" }}
                >
                  <li>
              ...
              <div className="col-8 col-lg-8 wow fadeIn" data-wow-delay=".2s">
                <iframe
                  src="https://www.google.com/maps/d/embed?mid=10c_T6p_SL7HNzS7_Y7pbwbFVw5OYqnE&ehbc=2E312F"
                  width="640"
                  height="480"
                  title="Maps"
                ></iframe>
